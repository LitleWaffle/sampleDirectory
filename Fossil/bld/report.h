...
int output_separated_file(void *pUser,int nArg,char **azArg,char **azName);
...
int sqlite3_exec_readonly(sqlite3 *db,const char *zSql,sqlite3_callback xCallback,void *pArg,char **pzErrMsg);
